...
let summary = "Type Provider for wrapping primitive types to restrict possible range of valid values"

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Type Provider for wrapping primitive types to restrict possible range of valid values"

// List of author names (for NuGet package)
let authors = [ "Tomasz Heimowski" ]

// Tags for your project (for NuGet package)
let tags = "FSharp Primitive Type Provider"

// File system information 
let solutionFile  = "FsPrimo.sln"
